...
export class OcurrencesController {
    ...
    async getOcurrences(
        ...
        return await this.ocurrencesService.findOcurrences(req.user.id, req.user.role, parseInt(query.page), parseInt(query.limit), query.isArchive, query.queryStudent)
    }
